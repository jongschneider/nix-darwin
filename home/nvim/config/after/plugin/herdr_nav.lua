-- vim-herdr-navigation — Neovim side (vendored from paulbkim-dev/vim-herdr-navigation)
--
...
--
-- Lives in after/plugin so it loads after lazy.nvim plugins and wins over any
-- other <C-h/j/k/l> mapping. The herdr-side keybinds live in
-- home/herdr/config.toml; the plugin itself is installed imperatively via
